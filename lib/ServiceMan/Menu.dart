...
import 'package:servifiy/ServiceMan/ProfileInfo.dart';
import 'package:servifiy/User/ProfilePage.dart';
import 'package:servifiy/utils.dart';

class ServiceManMenu extends StatefulWidget {
  @override
  State<ServiceManMenu> createState() => _ServiceManMenuState();
}

class _ServiceManMenuState extends State<ServiceManMenu> {
  @override
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ServicemanProfile()));
                                          },
                                          child: Container(
                                            // name7EZ (25:1882)
                                            margin: EdgeInsets.fromLTRB(0 * fem,
